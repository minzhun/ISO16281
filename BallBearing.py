...
# bearing_type
# 1 - deep groove ball bearing, angular contact ball bearing
# 2 - thrust ball bearing, thrust angular contact ball bearing
...
class BallBearing:
    ...
    def __capacity(self, basic_capacity):
        ...
        if self.type == 2 and self.alpha_deg != 90.0:
