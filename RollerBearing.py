...
# bearing.geometry(s, use_profile_or_not)
...
class RollerBearing:
    ...
    # bearing geometry
    def geometry(self, s, use_profile_or_not=0):
        ...
        # define roller profile
        self.__roller_profile(use_profile_or_not)
    ...
    # spring constant for steel material
    def stiffness(self, material):
        if material.mat_name != "Steel":
            print("The stiffness is only defined for steel in ISO/TS 16281")
        # N / mm**10/9
    ...
    def info(self):
        print("i  =  %2d" % self.i)
        print("Z  =  %2d" % self.Z)
        print("Dwe  =  %.2f" % self.Dwe)
        print("Dpw  =  %.2f" % self.Dpw)
        print("Lwe  =  %.2f" % self.Lwe)
    ...
    # Equation 60
    def __concentration_edge_stress(self, use_or_not):
        if use_or_not == 1:
