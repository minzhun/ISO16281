...
def geometry_clicked():
    ...
    error_flag = temp_ball_bearing.check()
...
def stiffness_clicked():
    ...
    if error_flag == 0:
        ...
        print("stiffness clicked", error_flag)
...
def disp_clicked():
    ...
    if error_flag == 0:
        ...
        print("displacement clicked", error_flag)
...
def rating_clicked():
    ...
    if error_flag == 0:
        ...
        print("rating clicked", error_flag)
...
if __name__ == "__main__":
    ...
    temp_ball_bearing = BallBearing(1, 7, 11.5, 43.5, 0.0, 0.0, 1)
    error_flag = 0
